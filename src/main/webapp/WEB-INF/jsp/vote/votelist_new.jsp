	...
	<table id="travel">
	    ...
	    <tbody>
	        ...
	        <tr>
	            ...
	            <td><a href="javascript:openPage(${item.voteId });">查看</a></td>
	        </tr>
	        </c:forEach>
	    </tbody>
	</table>
...
<script>
function openPage(voteId)
{
	window.open("${pageContext.request.contextPath}/showvote/showvotedetailpage?voteid=" + voteId);
}
</script>